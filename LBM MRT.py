...
viscosity counteraction (not implemented, increase stability)
...
dx = 1/Npt
dt = 1 # decrease to increase stability
...
"initialize to create a right flow"
...
im2=ax[1].imshow(np.sqrt(uy**2+ux**2), cmap='jet',norm=plt.Normalize(-.5, .5)) 
